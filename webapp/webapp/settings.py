# Django settings for SinglyHarp project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'singly_harp',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'e&amp;jo^kq5p_dod%)f-no_nusgo2u08$uip=2&amp;-fd2aqw4tlg6ns'
